...
COUNTDOWN_VECTORS = [
    ...
    ("2026-05-05", "母亲节", 5),      # 母亲节 2026-05-10（5 月第 2 个星期日）
    ("2026-11-22", "感恩节", 4),      # 感恩节 2026-11-26（11 月第 4 个星期四）
]

# 节日横幅单独钉几个：公历、农历、节气、按星期算的、以及"月末"写法的除夕
BANNER_VECTORS = [
    ("2026-10-01", "国庆节"),
    ("2026-04-05", "清明节"),
    ("2026-09-25", "中秋节"),
    ("2027-02-05", "除夕"),
    ("2026-02-10", "小年"),           # 农历腊月廿三
    ("2026-03-20", "龙抬头"),         # 农历二月初二
    ("2026-05-10", "母亲节"),         # 5 月第 2 个星期日
    ("2026-06-21", "父亲节"),         # 6 月第 3 个星期日
    ("2026-11-26", "感恩节"),         # 11 月第 4 个星期四
]
