...
DEFAULT_SITES = [
    ...
    {"name": "MC 官网", "url": "https://www.minecraft.net/zh-hans",
     "info": "Minecraft 官方网站", "icon": "https://www.minecraft.net/favicon.ico", "icon_fallback": ICON_PROXY.format(domain="www.minecraft.net")},
